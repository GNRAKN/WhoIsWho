...
public class EmailController {
	...
	public ModelAndView showEmailForm(ModelMap model, @RequestParam("personelEposta") String personelEposta) {
		modelViewObj = new ModelAndView("emailForm");
		modelViewObj.addObject("personelEposta",personelEposta);
		return modelViewObj;
	}

	// @RequestMapping(value = {"emailForm"}, method = RequestMethod.POST)
	// public ModelAndView showEmailFormPost(@RequestParam("personelEposta")
